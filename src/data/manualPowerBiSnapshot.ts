...
export const MANUAL_POWER_BI_SNAPSHOT: ManualPowerBiSnapshot = {
  ...
  // as "17 SEP 2026 · 05:28" rather than a bare date.
  updatedAt: '2026-09-17T05:28:00+02:00',
  ...
  // (16,141.51). The real Final Score is VCDB x Factor: 16,141.51 x 1.3 =
  // 20,983.97 (per the official standings, not a re-derivation here).
  finalScore: 20983.97,
  ...
  topThree: [
    { position: 1, team: 'Zwolle', finalScore: 20983.97 },
    { position: 2, team: 'Rotterdam', finalScore: 15272.22 },
